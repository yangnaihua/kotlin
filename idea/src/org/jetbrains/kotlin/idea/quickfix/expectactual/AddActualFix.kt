...
class AddActualFix(
    ...
    override fun invoke(project: Project, editor: Editor?, file: KtFile) {
        ...
        val pureActualClass = factory.generateClassOrObjectByExpectedClass(project, expectedClass, actualNeeded = true)
        for (declaration in pureActualClass.declarations) {
            if (element.declarations.any { it.name == declaration.name }) continue
