...
class KotlinUastLanguagePlugin : UastLanguagePlugin {
    ...
    internal fun convertDeclaration(element: PsiElement,
        ...
        fun <P : PsiElement, K: KtElement> build2( ktElement: K, ctor: (P,K, UElement?) -> UElement): () -> UElement? {
            return { ctor(element as P, ktElement, givenParent) }
        }
        fun <P : PsiElement, K: KtElement> buildk( ktElement: K?, ctor: (P,K?, UElement?) -> UElement): () -> UElement? {
            return { ctor(element as P, ktElement, givenParent) }
        }
        ...
        return with(requiredType) {
            when (original) {
                ...
                is KtLightFieldImpl.KtLightEnumConstant -> el<UEnumConstant>(buildk(original.kotlinOrigin,::KotlinUEnumConstant))
                is KtLightField -> el<UField>(buildk(original.kotlinOrigin, ::KotlinUField))
                is KtLightParameter -> el<UParameter>(buildk(original.kotlinOrigin, ::KotlinUParameter))
                is UastKotlinPsiParameter -> el<UParameter>(buildk(original.ktParameter, ::KotlinUParameter))
                is UastKotlinPsiVariable -> el<UVariable>(build2(original.ktElement,::KotlinUVariable))
