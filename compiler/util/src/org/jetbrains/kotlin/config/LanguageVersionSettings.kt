...
enum class LanguageFeature(
    ...
    SoundSmartCastsAfterTry(KOTLIN_1_3),
    LateinitTopLevelProperties(KOTLIN_1_3),
    LateinitLocalVariables(KOTLIN_1_3),
    AssigningArraysToVarargsInNamedFormInAnnotations(KOTLIN_1_3),
    ExpectedTypeFromCast(KOTLIN_1_3),
