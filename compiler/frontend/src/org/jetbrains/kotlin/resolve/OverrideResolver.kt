...
import org.jetbrains.kotlin.resolve.DescriptorUtils.classCanHaveAbstractMembersFromBaseClassifier
...
class OverrideResolver(
    ...
    private inner class CollectErrorInformationForInheritedMembersStrategy(
        ...
        internal fun doReportErrors() {
            val canHaveAbstractMembers = classCanHaveAbstractMembersFromBaseClassifier(classDescriptor)
