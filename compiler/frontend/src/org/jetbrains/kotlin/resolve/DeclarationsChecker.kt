...
import org.jetbrains.kotlin.resolve.DescriptorUtils.classCanHaveExplicitAbstractMember
...
class DeclarationsChecker(
    ...
    private fun checkMemberProperty(
        ...
        if (modifierList != null) {
            if (modifierList.hasModifier(KtTokens.ABSTRACT_KEYWORD)) {
                ...
                if (!classCanHaveExplicitAbstractMember(classDescriptor)) {
    ...
    fun checkFunction(function: KtNamedFunction, functionDescriptor: SimpleFunctionDescriptor) {
        ...
        if (containingDescriptor is ClassDescriptor) {
            ...
            if (hasAbstractModifier && !classCanHaveExplicitAbstractMember(containingDescriptor)) {
