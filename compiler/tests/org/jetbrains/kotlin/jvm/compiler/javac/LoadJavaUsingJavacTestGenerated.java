...
public class LoadJavaUsingJavacTestGenerated extends AbstractLoadJavaUsingJavacTest {
    ...
    public static class CompiledKotlinWithStdlib extends AbstractLoadJavaUsingJavacTest {
        ...
        public static class Contracts extends AbstractLoadJavaUsingJavacTest {
            ...
            @TestMetadata("isInstacePredicate.kt")
            public void testIsInstacePredicate() throws Exception {
                String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/loadJava/compiledKotlinWithStdlib/contracts/isInstacePredicate.kt");
                doTestCompiledKotlinWithStdlib(fileName);
            }
